...
const AuthPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isSignUp) {
        // Sign up logic
        response = await axios.post("http://ecoguard-522e.onrender.com/api/v1/users", {
          username,
          location,
          email,
          password,
        ...
        // Log in logic
        response = await axios.post("http://ecoguard-522e.onrender.com/api/v1/users/login", {
          username,
          password,
        });
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      ...
      const response = await axios.post("http://ecoguard-522e.onrender.com/api/v1/users/verify-otp", {
        userId: userData.id,
        otp: enteredOTP
      });
