...
export function DeforestationDetectionLandingJsx() {
  ...
  const Line=() =>(
    ...
    const getAqiColor = (score) => {
      // Define your logic for coloring based on AQI score
  ...
  return (
    (<div className="container mx-auto px-0 py-0">
      ...
      <button onClick={sendDeforestationRequest}
            type="submit"
      ...
      {/* <p>{resData ? JSON.stringify(resData) : 'No data available.'}</p>
      <p>{resData.message ? JSON.stringify(resData.message) : 'No data available.'}</p> */}

<div
  className="mb-6 mt-6 bg-gray-200 h-[40rem] flex items-center justify-center rounded-md overflow-hidden">
  <Image
    ...
    className={resData.satellite_image ? 'w-full h-full object-cover'  : 'w-300 h-300 object-contain'} />
      ...
      {/* Deforestation Percentage and Trees to Plant */}
